...
class FactCheckService(BaseService):
    ...
    def __init__(
        self,
        fact_check_repo: FactCheckRepository,
    ...
    async def get_fact_check_by_article(
        self,
        article_id: UUID
    ) -> Optional[ArticleFactCheck]:
        """
    ...
    async def _update_article_credibility(
        self,
        article_id: UUID,
