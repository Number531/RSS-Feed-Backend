...
async def get_fact_check_trends(
    ...
    source_id: Optional[str] = Query(None, description="Filter by specific source UUID"),
    ...
    try:
        ...
        return {
            ...
            "summary": {"total_periods": len(time_series), "overall_avg_score": overall_avg},
        }
...
async def get_claims_analytics(
    ...
    try:
        ...
        claims_stats = await analytics_service.get_claims_statistics(verdict=verdict, days=days)
...
async def get_verdict_details(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to retrieve verdict analytics")
