...
class RSSSourceBase(BaseModel):
    ...
    source_name: str = Field(..., min_length=1, max_length=100, description="Source organization (e.g., 'CNN', 'BBC')")
    category: str = Field(..., pattern="^(general|politics|us|world|science|technology|business|entertainment|sports|health)$", description="Feed category")
